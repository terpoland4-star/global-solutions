        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="animate-fade-up-delay-2">
            <h1 className="font-display leading-none tracking-tight mb-6" style={{ fontSize: 'clamp(52px, 8vw, 96px)', color: 'var(--cream)', maxWidth: '900px', letterSpacing: '-0.03em' }}>
              ...
              <span className="glow-text" style={{ color: 'var(--indigo-light)', display: 'inline-block' }}>l’intelligence des langues.</span>
            </h1>
          </div>
          ...
          <div className="animate-fade-up-delay-4 flex flex-wrap gap-4 items-center mb-16">
            <button className="btn-primary flex items-center gap-2">Lancer un projet <ArrowRight size={16} /></button>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display leading-tight" style={{ fontSize: 'clamp(32px, 4.5vw, 56px)', letterSpacing: '-0.03em', color: '#0A0F1E' }}>
              Des solutions qui allient<br /><span style={{ color: 'var(--indigo)' }}>le verbe et le code</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              <div className="flex-1 rounded-2xl p-8" style={{ background: '#F5F3FF', border: '1px solid #DDD6FE' }}>
                <div className="inline-flex items-center justify-center w-11 h-11 rounded-xl mb-5" style={{ background: '#EDE9FE' }}><Languages size={20} style={{ color: '#7C3AED' }} /></div>
                <h3 className="font-display text-xl font-bold mb-2" style={{ color: '#1E1B4B' }}>Traduction & interprétation</h3>
                <p className="text-sm leading-relaxed" style={{ color: '#6B7280' }}>15+ langues (français, anglais, arabe, songhaï, tamasheq, tadaksahak, haoussa…). Interprétation consécutive, simultanée, de liaison. Référence humanitaire (ONU, IOM, Takuba).</p>
              </div>
              <div className="flex-1 rounded-2xl p-8" style={{ background: '#F0FDF4', border: '1px solid #BBF7D0' }}>
                <div className="inline-flex items-center justify-center w-11 h-11 rounded-xl mb-5" style={{ background: '#DCFCE7' }}><Sparkles size={20} style={{ color: '#15803D' }} /></div>
                <h3 className="font-display text-xl font-bold mb-2" style={{ color: '#14532D' }}>Annotation IA & données linguistiques</h3>
                <p className="text-sm leading-relaxed" style={{ color: '#6B7280' }}>Constitution de corpus, transcription, annotation sémantique pour modèles NLP. Une expertise unique sur les langues à faibles ressources.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="flex-1 flex justify-center">
              <div className="w-full max-w-sm p-1 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600">
                <div className="bg-navy-card rounded-2xl p-6 text-center" style={{ background: '#161D2F' }}>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="font-display" style={{ fontSize: 'clamp(28px, 4vw, 48px)', letterSpacing: '-0.03em', color: '#0A0F1E' }}>
              Ils conjuguent langues et technologie<br/><span style={{ color: 'var(--indigo)' }}>avec HAM Global Words</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "L'application mobile que HAM Global Words a développée pour notre programme d'alphabétisation (songhaï/français) est un modèle d'ergonomie et de robustesse. L'équipe a su combiner traduction pédagogique et technologie adaptée aux zones rurales.", name: "Aissata Diallo", role: "Directrice", company: "Éducation pour Tous", initials: "AD", color: '#6366F1', stars: 5 },
              { quote: "Nous avions besoin d’une plateforme web pour gérer nos interprètes dans 12 pays. HAM Global Words a livré un dashboard personnalisé, sécurisé et multilingue. Un vrai partenaire technique.", name: "Marc T. Andersen", role: "CTO", company: "Lingua Mundi", initials: "MT", color: '#8B5CF6', stars: 5 },
              { quote: "Leur double compétence (linguistique + dev) est inestimable. Ils ont annoté un corpus en tamasheq pour notre moteur de traduction automatique, puis ont intégré l'API dans notre outil interne. Rapidité, précision, écoute.", name: "Dr. Yann Le Goff", role: "Head of AI", company: "NLP4Good", initials: "YL", color: '#EC4899', stars: 5 },
            ].map(t => (
